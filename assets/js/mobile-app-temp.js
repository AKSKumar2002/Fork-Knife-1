...
class MobileAppController {
    ...
    `;
      ...
      <div class="mobile-drawer-nav">
        <a href="index.html#home" class="mobile-drawer-link active" data-section="home">
          <ion-icon name="home-outline" class="mobile-drawer-icon"></ion-icon>
          <span>Home</span>
        </a>
        <a href="menu.html" class="mobile-drawer-link" data-section="menu">
          <ion-icon name="restaurant-outline" class="mobile-drawer-icon"></ion-icon>
          <span>Menu</span>
        </a>
        <a href="index.html#about" class="mobile-drawer-link" data-section="about">
          <ion-icon name="information-circle-outline" class="mobile-drawer-icon"></ion-icon>
          <span>About Us</span>
        </a>
        <a href="index.html#" class="mobile-drawer-link" data-section="chefs">
          <ion-icon name="people-outline" class="mobile-drawer-icon"></ion-icon>
          <span>Our Chefs</span>
        </a>
        <a href="index.html#" class="mobile-drawer-link" data-section="contact">
        ...
        <a href="index.html#" class="mobile-drawer-link" data-section="reservation">
      ...
      <div class="mobile-drawer-footer">
        ...
        <a href="index.html#" class="mobile-drawer-contact">
    ...
    `;
        ...
        bottomNav.innerHTML = `
      <a href="index.html#home" class="mobile-nav-item active ripple" data-nav="home">
        <ion-icon name="home" class="mobile-nav-icon"></ion-icon>
        <span>Home</span>
      </a>
      <a href="menu.html" class="mobile-nav-item ripple" data-nav="menu">
        <ion-icon name="restaurant" class="mobile-nav-icon"></ion-icon>
        <span>Menu</span>
      </a>
      <a href="index.html#" class="mobile-nav-item ripple" data-nav="reservation">
        <ion-icon name="calendar" class="mobile-nav-icon"></ion-icon>
        <span>Book</span>
      </a>
      <a href="index.html#about" class="mobile-nav-item ripple" data-nav="about">
        <ion-icon name="information-circle" class="mobile-nav-icon"></ion-icon>
        <span>About</span>
      </a>
      <a href="index.html#" class="mobile-nav-item ripple" data-nav="more">
